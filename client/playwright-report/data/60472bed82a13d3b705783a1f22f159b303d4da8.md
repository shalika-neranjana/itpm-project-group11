...
- Name: it23569140-samarakoon-reviews-feedbacks\review-forum-interactions.spec.js >> Review Forum Interactions >> should mark a review as helpful
- Location: tests\it23569140-samarakoon-reviews-feedbacks\review-forum-interactions.spec.js:76:3
...
Call log:
  - waiting for locator('div.mb-6').filter({ has: getByRole('heading', { name: 'Sysco LABS' }) }).first().getByRole('button', { name: /Helpful/ })
