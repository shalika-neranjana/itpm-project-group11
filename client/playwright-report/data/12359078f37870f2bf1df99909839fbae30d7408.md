...
- Name: it23569140-samarakoon-reviews-feedbacks\review-forum-sorting.spec.js >> Review Forum Sorting >> should switch back to latest sorting
- Location: tests\it23569140-samarakoon-reviews-feedbacks\review-forum-sorting.spec.js:80:3
...
Locator: locator('div.mb-6 h3').first()
Expected: "WSO2"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.mb-6 h3').first()
...
```ts
  ...
  39 | }
  40 | 
  41 | test.describe('Review Forum Sorting', () => {
  ...
  67 |   })
  68 | 
  69 |   test('should sort reviews by latest (default)', async ({ page }) => {
  70 |     const firstCardHeading = page.locator('div.mb-6 h3').first()
  71 |     await expect(firstCardHeading).toHaveText('WSO2')
  72 |   })
  73 | 
  74 |   test('should sort reviews by top rated', async ({ page }) => {
  75 |     await page.getByRole('button', { name: 'Top Rated' }).click()
  76 |     const firstCardHeading = page.locator('div.mb-6 h3').first()
  77 |     await expect(firstCardHeading).toHaveText('WSO2')
  78 |   })
  79 | 
  80 |   test('should switch back to latest sorting', async ({ page }) => {
  81 |     await page.getByRole('button', { name: 'Top Rated' }).click()
  82 |     await page.getByRole('button', { name: 'Latest' }).click()
  83 |     const firstCardHeading = page.locator('div.mb-6 h3').first()
> 84 |     await expect(firstCardHeading).toHaveText('WSO2')
     |                                    ^ Error: expect(locator).toHaveText(expected) failed
  85 |   })
  86 | })
  87 | 
